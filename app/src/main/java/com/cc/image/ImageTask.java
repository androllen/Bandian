package com.cc.image;

import android.graphics.Point;
import android.graphics.drawable.BitmapDrawable;

import com.cc.image.iface.ImageLoadHandler;
import com.cc.tool.CCDebug;
import com.cc.tool.util.Encrypt;
...
public class ImageTask {
    ...
    protected static final String LOG_TAG = CCDebug.DEBUG_IMAGE_LOG_TAG_TASK;
     ...
     *
     * @return
     * @deprecated Do not overwrite this method, use {@link com.cc.image.iface.NameGenerator} instead.
     * should be used.
     */
    @Deprecated
    ...
    /**
     * Check the given {@link ImageLoadRequest} is loading.
     *
     * @param request
