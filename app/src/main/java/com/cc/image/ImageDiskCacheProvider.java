...
import com.cc.cache.DiskCacheProvider;
import com.cc.diskcache.CacheEntry;
import com.cc.diskcache.DiskCache;
import com.cc.diskcache.lru.SimpleDiskLruCache;
import com.cc.image.iface.ImageDownloader;
import com.cc.image.impl.SimpleDownloader;
...
public class ImageDiskCacheProvider extends DiskCacheProvider {
    ...
    protected static final String LOG_TAG = CCDebug.DEBUG_IMAGE_LOG_TAG_PROVIDER;
