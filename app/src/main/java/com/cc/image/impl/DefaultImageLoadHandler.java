...
import com.cc.image.drawable.RoundedDrawable;
...
public class DefaultImageLoadHandler implements ImageLoadHandler {
    ...
    private final static boolean DEBUG = CCDebug.DEBUG_IMAGE;
    private final static String LOG_TAG = CCDebug.DEBUG_IMAGE_LOG_TAG;
