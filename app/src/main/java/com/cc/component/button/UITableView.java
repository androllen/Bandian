...
//							R.layout.ctl_cpt_list_item_top, null);
//				} else if (mIndexController == mItemList.size() - 1) {
//					tempItemView = mInflater.inflate(
//							R.layout.ctl_cpt_list_item_bottom, null);
//				} else {
//					tempItemView = mInflater.inflate(
//							R.layout.ctl_cpt_list_item_middle, null);
//				}
//				setupItem(tempItemView, obj, mIndexController);
//				tempItemView.setClickable(obj.isClickable());
//				mListContainer.addView(tempItemView);
//
//				LinearLayout tv=(LinearLayout)mInflater.inflate(R.layout.ctl_cpt_line, null);
//				mListContainer.addView(tv);
//
//				mIndexController++;
//			}
//
//			mListContainer.removeViewAt(mListContainer.getChildCount()-1);
//		} else if (mItemList.size() == 1) {
//			// when the list has only one item
//			View tempItemView = mInflater.inflate(
//					R.layout.ctl_cpt_list_item_single, null);
